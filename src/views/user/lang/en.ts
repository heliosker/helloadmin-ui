export default {
    ...
    'login.login': 'Login',
    'login.system': 'Front and rear end separation management system based on gin + ant design Vue UI',
    ...
    'dashboard.analysis.addCustomer': 'New visitors (person)',
    'dashboard.analysis.money': 'Reward amount',
    'dashboard.analysis.concerned': 'Number of people concerned',
    'dashboard.analysis.compare_last_month': 'Compared with last month'
}
